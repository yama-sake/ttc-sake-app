...
const RiceSelect = ({ value, onChange }) => {
  const v = value || '';
  const inList = v === '' || v === RICE_OTHER || v === RICE_UNKNOWN || SAKE_RICE_OPTIONS.includes(v);
  return (
    <select value={v} onChange={onChange}>
      <option value="">選択してください</option>
      {SAKE_RICE_OPTIONS.map(r => <option key={r} value={r}>{r}</option>)}
      {!inList && <option value={v}>{v}（読取）</option>}
            ...
            {!analysisResult ? (
              ...
              <div className="confirmation-section">
                ...
                <div className="result-form">
                  ...
                  <div className="form-group">
                    <label>酒米</label>
                    <RiceSelect value={analysisResult.sakeRice} onChange={(e) => setAnalysisResult({...analysisResult, sakeRice: e.target.value})} />
                  </div>
                </div>
              ...
              <div className="modal-overlay" onClick={() => setEditingSake(null)}>
                <div className="modal-content" onClick={e => e.stopPropagation()}>
                  ...
                  <div className="result-form">
                    ...
                    <div className="form-group"><label>酒米</label><RiceSelect value={editingSake.sakeRice} onChange={(e) => setEditingSake({...editingSake, sakeRice: e.target.value})} /></div>
                  </div>
                  <div className="modal-buttons">
